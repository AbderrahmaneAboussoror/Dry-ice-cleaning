                ...
                <div className="hidden md:block overflow-x-auto">
                    <table className="w-full text-left">
                        ...
                        <tr className="border-b border-gray-200">
                            ...
                            <th className="py-3 px-4 text-gray-700 font-normal text-sm">{t('appointments.table.status')}</th>
                        </tr>
                        </thead>
                        <tbody>
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full text-left min-w-[700px]">
                            ...
                            <tr className="border-b border-gray-200">
                                ...
                                <th className="py-3 px-3 text-gray-700 font-normal text-sm whitespace-nowrap">{t('appointments.table.status')}</th>
                            </tr>
                            </thead>
                            <tbody>
                            {appointments.map((appointment) => {
