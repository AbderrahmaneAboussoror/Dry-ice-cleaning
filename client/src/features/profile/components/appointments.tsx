      ...
      <section className="bg-white p-4 md:p-6 rounded-lg shadow-[0px_1px_3px_rgba(0,0,0,0.1),0px_3px_3px_rgba(0,0,0,0.1)]">
        ...
        {!error && appointments.length === 0 && (
            <div className="text-center py-8">
              ...
              <p className="text-gray-400 text-sm mt-1">Your future appointments will appear here</p>
            </div>
        )}
            ...
            <div className="hidden md:block overflow-x-auto">
              <table className="w-full text-left">
                ...
                <tr className="border-b border-gray-200">
                  {["Date", "Time", "Service", "Location", "Points", "Status"].map((th) => (
                      <th
                          key={th}
            ...
            <div className="md:hidden sm:block hidden">
              <div className="overflow-x-auto">
                <table className="w-full text-left min-w-[700px]">
                  <thead>
                  <tr className="border-b border-gray-200">
                    {["Date", "Time", "Service", "Location", "Price", "Status"].map((th) => (
                        <th
                            key={th}
