...
const formatPoints = (pointsAwarded: number, bonusPointsAwarded: number, freeServices: any[]) => {
  ...
  let pointsText = `${totalPoints.toLocaleString()} points`;
      ...
      <section className="bg-white p-4 md:p-6 rounded-lg space-y-4 md:space-y-6 shadow-[0px_1px_3px_rgba(0,0,0,0.1),0px_3px_3px_rgba(0,0,0,0.1)]">
        ...
        {!error && purchases.length === 0 && (
            <div className="text-center py-8">
              ...
              <p className="text-gray-400 text-sm mt-1">Your purchased packs will appear here</p>
            </div>
        )}
                ...
                <tr className="border-b border-gray-200">
                  {[
                    ...
                    "Status",
                      ...
                      <th
                          key={th}
                          className="py-3 px-4 text-gray-700 font-normal text-sm"
                      >
                        {th}
                      </th>
                  ))}
                        ...
                        <td className="py-3 px-4">
                          <div>
                            <div className="font-medium text-gray-900">
                              {(purchase.pointsAwarded + purchase.bonusPointsAwarded).toLocaleString()} points
                            </div>
                            {purchase.bonusPointsAwarded > 0 && (
                                <div className="text-xs text-green-600 mt-1">
                                  +{purchase.bonusPointsAwarded} bonus points
                                </div>
                            )}
                  ...
                  <tr className="border-b border-gray-200">
                    {[
                      ...
                      "Status",
                        ...
                        <th
                            key={th}
                            className="py-3 px-3 text-gray-700 font-normal text-sm whitespace-nowrap"
                        >
                          {th}
                        </th>
                    ))}
                    ...
                    return (
                        ...
                        >
                          ...
                          <td className="py-3 px-3 whitespace-nowrap">
                            <div>
                              <div className="font-medium text-gray-900">{purchase.packId.name}</div>
                              <div className="text-xs text-gray-500">{purchase.packId.description}</div>
                            </div>
                          </td>
                          <td className="py-3 px-3 whitespace-nowrap">
                            {formatPoints(
